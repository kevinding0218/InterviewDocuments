...
- 1st solution
	...
	- Execution on a Two Cores CPU
		...
		- T2 tries to enter `getInstance()`, of course it cannot because T1 is in it, holding the key of the syncrhon
<!--stackedit_data:
eyJoaXN0b3J5IjpbMTc2OTAzOTk5MCwxMTY5NDc0NTY3LC0xNj
