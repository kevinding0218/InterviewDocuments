...
- Impact:
	...
	- False sharing happens in an invisible way, because when we write a class, we have no idea of how the class and its fields are laid out in memory, it's hard to predict, 
	- 
<!--stackedit_data:
eyJoaXN0b3J5IjpbLTQzNzA5NDIxMCwtMTUyOTcwODMxNSwtMj
