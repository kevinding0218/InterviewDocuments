...
Well, we can also customize our own Dispatcher to make Coroutine not swtiching back to previous Thread, and that is all our decision
```
1 launch(Dispatchers.Main) {
2    ...
5    val image = suspendingGetImage(imageId)
...
<!--stackedit_data:
eyJoaXN0b3J5IjpbMTYyNTQwMTYyMSwtMTE1OTI1MTE4NiwyMj
