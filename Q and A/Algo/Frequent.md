...
3. 从左到右扫描StringBuilder sb，StringBuilder result每次遇到"("，decrease openToKeep, 如果openToKeep < 0则删除 `if (c == '(') {openToKeep--;if (openToKeep < 0) {continue;} }`
...
<!--stackedit_data:
eyJoaXN0b3J5IjpbLTY5OTE0MTI4MSwtMTk2Nzk4OTEzNSwxMj
