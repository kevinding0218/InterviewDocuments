...
- To create a pipeline like a build service on your own using the docker, to define different steps to do different things.
	...
	- Second step is to use aspnetcore runtime and in `COPY` command `from`, within which I can specify that I want to use the output from my previous step which is built in a
```DOCKER
...
```
<!--stackedit_data:
eyJoaXN0b3J5IjpbNjc0MzMyNTU0LDYxODg2MjIxNiw1Mjk5MT
